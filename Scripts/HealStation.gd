...
func add_item_to_healstation(item: Node):
	if pickup_items.size() < max_items:
		...
		print("Item added to healstation:", item.name)
	else:
		print("healstation is full, can't add more items.")

func remove_item_from_healstation() -> Node:
